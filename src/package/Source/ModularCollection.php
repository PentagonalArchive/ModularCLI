...
use Pentagonal\ModularCLI\Source\Exceptions\ModularNotFoundException;
...
class ModularCollection implements Countable, ArrayAccess
{
    ...
    {
        return new ArrayCollection($this->internalGetModular($modularName)->getModularInfo());
    }
    ...
    {
        $modularInfo = new ArrayCollection();
